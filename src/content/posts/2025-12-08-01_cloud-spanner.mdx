...
coverImage: '@@/2025-12-08-01_cloud-spanner/ogp.webp'
---

先日，職場の Tech Blog で Spanner (Google Cloud) の記事を公開しました．単なる使い方の紹介ではなく，普段はブラックボックスのコアアーキテクチャを技術的な視点から紐解きました．個人的にかなり力作なので，もし良ければご一読ください．

(ToDo: あとでリンク変更)

https://sreake.com/blog/
