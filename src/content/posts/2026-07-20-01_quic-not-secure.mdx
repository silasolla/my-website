...
description: 'このサイトを Workers に移してから警告が出るようになったので調査しました．対症療法は試しましたが根本的な理由は分かっていません．'
---
...
0-RTT の Early Data には，通常の通信より弱い面もあるようです．[RFC 9846](https://www.rfc-editor.org/info/rfc9846/) には，Early Data が前方秘匿性を持たず，接続を跨いだ再送に関して保証しないと明記されていました [^rfc-9846]．今回のケースと関係するかは分かりませんが，まあ OFF にしても実害は無いでしょう．
...
[^rfc-9846]: 2.3 節の IMPORTANT NOTE にあります．
