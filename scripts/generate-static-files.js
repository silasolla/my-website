...
import { backgroundColor, themeColor } from '../src/data/theme.mjs';
...
const webmanifestPath = join(publicDir, 'site.webmanifest');
writeFileSync(webmanifestPath, `${webmanifestContent}\n`, 'utf-8');
